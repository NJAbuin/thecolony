...
function RecruiterContainer(props) {
    ...
    return (
        <Switch>
            ...
            <Route exact path="/auth/recruiter/jobpostings/:id" component={JobPostingDetails} />
            <Route exact path="/auth/recruiter/jobpostings" component={RecruiterJobPostings} />
            <Route exact path="/auth/recruiter/candidates" component={RecruiterCandidates} />
